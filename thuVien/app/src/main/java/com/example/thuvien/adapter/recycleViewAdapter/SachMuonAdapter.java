...
public class SachMuonAdapter extends RecyclerView.Adapter<SachMuonAdapter.ThemHolder> {
    private List<DauSachThem> list;
    private ThemAdapterListener listener;

    public SachMuonAdapter() {
        list = new ArrayList<>();
    }
    ...
    public ThemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_tim_sach, parent, false);
    ...
    public void onBindViewHolder(@NonNull ThemHolder holder, int position) {
        ...
        holder.tvTen.setText("Mã: " + dauSachThem.getId());
        holder.tvChuDe.setText(dauSachThem.getTen());
        holder.tvTacGia.setText("Tác giả: "+dauSachThem.getTacGia());
        holder.tvSoLuong.setText("Còn "+dauSachThem.getSoLuong()+" ngày");
    }
        ...
        public ThemHolder(@NonNull View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(listener != null){
                        listener.onClickSachMuonListener(view, list.get(getAdapterPosition()));
                    }
                }
            });
        }
    ...
    public interface ThemAdapterListener{
        void onClickSachMuonListener(View view, DauSachThem d);
    }
}
